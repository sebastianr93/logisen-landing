...
const PORTS = [
  {
    ...
    services: [
      "Retiros y entregas de importación",
      "Exportaciones y posicionamiento",
      "Coordinación con Exolgan, TRP y BACTSSA",
      "Gestión de turnos portuarios",
    ],
  ...
  },
  {
    ...
    services: [
      ...
      "Retiros de importación",
      "Cumplimiento de ventanas de embarque",
    ],
    coords: { top: "35%", left: "56%" },
    accent: "#1D4ED8",
  },
];
      ...
      <div className="container-max">
        ...
        >
          ...
          <p className="text-base max-w-xl mx-auto" style={{ color: "#64748B" }}>
            Presencia y experiencia operativa en los dos principales puertos de
            la región, con cobertura para toda la zona del Gran Buenos Aires.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              {/* Argentina SVG silhouette — simplified */}
              <svg
                viewBox="0 0 400 560"
              ...
              >
                ...
                >
                  ...
                  <text x="232" y="321" fill="white" fontSize="9" fontWeight="bold" fontFamily="Inter, sans-serif">
                    Puerto Bs. As.
                  </text>
                </motion.g>

                {/* Puerto Zárate marker */}
                <motion.g
                  initial={{ scale: 0 }}
                  whileInView={{ scale: 1 }}
                  viewport={{ once: true }}
                ...
                >
                  ...
                  <text x="237" y="271" fill="white" fontSize="9" fontWeight="bold" fontFamily="Inter, sans-serif">
                    Puerto Zárate
                  </text>
                </motion.g>
                ...
                {/* Labels */}
                <text x="200" y="40" fill="rgba(255,255,255,0.4)" fontSize="10" fontFamily="Inter" textAnchor="middle">
                  REPÚBLICA ARGENTINA
                </text>
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs" style={{ color: "#94A3B8" }}>Puerto Buenos Aires</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full" style={{ background: "#93C5FD" }} />
                    <span className="text-xs" style={{ color: "#94A3B8" }}>Puerto Zárate</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div
                      className="w-6 h-0.5"
                    ...
                    />
                    <span className="text-xs" style={{ color: "#94A3B8" }}>Ruta operativa</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {PORTS.map((port) => (
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  (e.currentTarget as HTMLElement).style.boxShadow = "0 8px 30px rgba(37,99,235,0.1)";
                }}
                onMouseLeave={(e) => {
              ...
              >
                ...
                >
                  ...
                  >
                    <Anchor size={20} style={{ color: "#60A5FA" }} />
                  </div>
                  <div>
                    <h3
